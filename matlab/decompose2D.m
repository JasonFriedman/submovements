...
t0 = bestParameters(1:4:end-3);
D = bestParameters(2:4:end-2);
Ax = bestParameters(3:4:end-1);
Ay = bestParameters(4:4:end);
...
bestParameters(1:4:end-3) = t0;
bestParameters(2:4:end-2) = D;
bestParameters(3:4:end-1) = Ax;
bestParameters(4:4:end) = Ay;